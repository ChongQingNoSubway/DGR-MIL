...
class NystromAttention(nn.Module):
    ...
    def forward(self, q, k, v, mask = None, return_attn = False):
        b, n, _, h, m, iters, eps = *q.shape, self.heads, self.num_landmarks, self.pinv_iterations, self.eps
        ...
        if remainder > 0:
            ...
            q = F.pad(q, (0, 0, padding, 0), value = 0)
            k = F.pad(k, (0, 0, padding, 0), value = 0)
            v = F.pad(v, (0, 0, padding, 0), value = 0)       
