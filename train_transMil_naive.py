...
from models.transmil_naive import TransMIL
...
def train(trainloader, milnet, criterion, optimizer, args):
    ...
    for batch_id, (feats,label) in enumerate(trainloader):
        ...
        optimizer.zero_grad()
        bag_prediction, _ = milnet(data=bag_feats)
...
def main():
    ...
    parser.add_argument('--optim', default='RAdam', type=str, help='Choice of optimizer [RAdam]')
    parser.add_argument('--seed', default='0', type=int, help='random seed')
    parser.add_argument('--save_dir', default='transmil_imagenetresnet_c16', type=str, help='the directory used to save all the output')
    ...
    if args.optim == 'RAdam':
        ...
        base_optimizer = torch.optim.AdamW(milnet.parameters(), lr=args.lr, betas=(0.5, 0.9), weight_decay=args.weight_decay)
        optimizer = Lookahead(base_optimizer)
